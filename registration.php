...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $subject = "sandeep yadav your verify the email";
        $verify_link = BASE_URL.'verify.php?email='.$to.'&token='.$token;
        $message = ''.LANG_VALUE_151.'<br><br>

<a href="'.$verify_link.'">'.$verify_link.'</a>';

        $headers = "From: noreply@golifeshooping.com" . BASE_URL . "\r\n" .
                   "Reply-To: noreply@golifeshooping.com" . BASE_URL . "\r\n" .
        ...
        $success_message = "mail recive sucessfully";
    }
}
?>
